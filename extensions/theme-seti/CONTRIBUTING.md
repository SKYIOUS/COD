...
- have the main branches of `https://github.com/jesseweed/seti-ui` and `https://github.com/SKYIOUS/COD` cloned in the same parent folder
...
- when done, create a PR with the changes in https://github.com/SKYIOUS/COD.
