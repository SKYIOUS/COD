...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			metadata: {
				description: localize2('minWelcomeDescription', 'Opens a Walkthrough to help you get started in COD.')
			}
		});
	}
	...
	properties: {
		...
		'workbench.startupEditor': {
			...
			'enumDescriptions': [
				...
				localize({ comment: ['This is the description for a setting. Values surrounded by single quotes are not to be translated.'], key: 'workbench.startupEditor.welcomePage' }, "Open the Welcome page, with content to aid in getting started with COD and extensions."),
