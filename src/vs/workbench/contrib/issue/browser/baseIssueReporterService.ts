...
export class BaseIssueReporterService extends Disposable {
	...
	public setSourceOptions(): void {
		...
		sourceSelect.append(this.makeOption(IssueSource.VSCode, localize('vscode', "COD"), false));
		sourceSelect.append(this.makeOption(IssueSource.Extension, localize('extension', "A COD extension"), false));
	...
	public async renderBlocks(): Promise<void> {
		...
		if (selectedExtension && this.nonGitHubIssueUrl) {
			...
			reset(descriptionTitle, localize('handlesIssuesElsewhere', "This extension handles issues outside of COD"));
